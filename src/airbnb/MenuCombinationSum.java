...
public class MenuCombinationSum {
    ...
    private void search(List<List<Double>> res, int[] centsPrices, int start,
                        int centsTarget, List<Double> curCombo, double[] prices) {
        if (centsTarget == 0) {
    ...
    public static void main(String[] args) {
        MenuCombinationSum solution = new MenuCombinationSum();
        double[] prices = { 0.1, 0.1, 0.3};
        List<List<Double>> res = solution.getCombos(prices, 0.4);
